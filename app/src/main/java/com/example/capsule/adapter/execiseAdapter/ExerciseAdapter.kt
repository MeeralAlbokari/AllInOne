package com.example.capsule.adapter.execiseAdapter
...
import com.example.capsule.databinding.ItemRowBinding

class ExerciseAdapter(
    private val exercises: MutableList<Exercise>
) : RecyclerView.Adapter<ExerciseAdapter.ItemHolder>() {
    ...
    inner class ItemHolder(itemView: ItemRowBinding) : RecyclerView.ViewHolder(itemView.root)
